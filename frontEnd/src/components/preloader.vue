<template>
  <div
    v-if="visible"
    class="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-gradient-to-r from-green-500 to-blue-500 text-white"
  >
...
const mensajes = [
  ...
  "Preparando sistema del centro comercial...",
  "Cargando locales...",
